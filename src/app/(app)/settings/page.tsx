  ...
  return (
    <div className="mx-auto max-w-2xl space-y-6 p-4 md:p-6">
      <SettingsSection
        ...
        icon={User}
        title="Profile"
        description="Your name, email, and timezone."
      >
        <ProfileForm />
      </SettingsSection>
      ...
      <SettingsSection
        ...
        icon={Bell}
        title="Notifications"
        description="Control reminders and how they reach you."
      >
      ...
      <SettingsSection
        ...
        icon={Palette}
        title="Appearance"
        description="Choose how Routiva looks on this device."
      >
        <AppearanceSettings />
      </SettingsSection>
      ...
      <SettingsSection
        ...
        icon={CalendarDays}
        title="Schedule"
        description="Defaults used when viewing your schedule."
      >
